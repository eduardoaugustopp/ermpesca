...
const DestinosAguaSalgada: React.FC = () => {
  ...
  useEffect(() => {
    const data: Destination[] = [
      {
        name: "Cananéia",
        link: "/destinos/cananeia",
        image: "/imagens/destinos/cananeia.jpg",
        description: "Explore as belezas naturais de Cananéia, com pescarias incríveis."
      },
      {
        name: "Ilha Comprida",
        link: "/destinos/ilha-comprida",
        image: "/imagens/destinos/ilha-comprida.jpg",
        description: "Aventura e tranquilidade em Ilha Comprida, perfeita para pesca."
      }
    ];
  ...
  return (
    <div className="text-center p-10 bg-white pb-20">
      <h1 className="text-black text-2xl font-bold mb-12">
        DESTINOS DE PESCA EM ÁGUAS SALGADAS
      </h1>
